...
#ifndef KFIREBASEAUTHINTEROP_SWIFT_H
#define KFIREBASEAUTHINTEROP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KFirebaseAuthInterop",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSError;
SWIFT_CLASS("_TtC20KFirebaseAuthInterop20KFirebaseAuthInterop")
@interface KFirebaseAuthInterop : NSObject
...
///
/// \param completion Completion handler with UID or error.
///
- (void)signInWithEmail:(NSString * _Nonnull)email password:(NSString * _Nonnull)password completion:(void (^ _Nonnull)(NSString * _Nullable, NSError * _Nullable))completion;
/// Sign out the current user.
///
/// returns:
/// NSError if sign out fails, otherwise nil.
- (void)logoutWithCompletion:(void (^ _Nonnull)(NSError * _Nullable))completion;
/// Get current logged-in user’s UID.
///
/// returns:
/// UID string or nil.
- (NSString * _Nullable)getCurrentUserId SWIFT_WARN_UNUSED_RESULT;
@end
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("KFirebaseAuthInterop", usrValue)
...
namespace KFirebaseAuthInterop SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("KFirebaseAuthInterop") {


} // namespace KFirebaseAuthInterop
